    ...
    <footer class="page-footer">
      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            Head Office: Archivers Fashion.<br>
            180-182 Thika, Kiambu.
          </address>
            <div class="phone">
              Telephone:
              <a class="phone__number" href="tel:0778998055">0778998055</a>
            </div>
            <div class="email">
              Email:
              <a href="mailto:support@storeachievers.com" class="email__addr">support@storearchivers.com</a>
            </div>
          </div>
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
          ...
          <div class="copyright">
            &copy; 2022 Archivers Fashion&trade;
          </div>
