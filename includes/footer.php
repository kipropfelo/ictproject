	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				Head Office: Achievers Fashion.<br>
				180-182 Thika Street, Kiambu.
			</address>
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:0778998055">0778-998-055</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:support@storeachievers.com" class="email__addr">support@storeachivers.com</a>
				</div>
			</div>
